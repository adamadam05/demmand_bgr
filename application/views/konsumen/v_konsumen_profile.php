<?php 
	...
	$this->view('include/v_sideleftkonsumen');
                                ...
                                <div class="x_content">
										...
										<div class="field item form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input class="form-control" type="hidden" name="kode_user" id="kode_user" placeholder="" required="required" value="<?= $kode_user ?>"/>
 ...
 <script src="http://maps.google.com/maps?file=api&v=2&key=ABQIAAAA7A7Eu8gZ_mTslgWnRR9TGRQByQgPDcFg0q0wOb9u6rRtBOFyKBQD4QgfPHRxBFGL7JviJdz_jAlHfw" type="text/javascript"></script>
	...
	<script>
		if (GBrowserIsCompatible()) 
		{
			...
			map.setCenter( new GLatLng(<?= $latitude ?>,<?= $longitude ?>), 14,0);
