            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="row">
                    <a href="<?= base_url("c_konsumen/konsumen_insert_po")?>" class="btn btn-primary">Add Pre-Order</a>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><center>
                            ...
                            <?php if($value->is_complete == 0 || $value->is_complete == ""){ ?>
                              <a href="<?php echo site_url('c_konsumen/konsumen_insert_po?buyer='.$value->buyer_id)?>" class="btn btn-info"><i class="fa fa-pencil"></i></a> 
                              <a href="<?php echo site_url('c_konsumen/delete_pemesanan/'.$value->buyer_id) ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                            <?php } ?>
