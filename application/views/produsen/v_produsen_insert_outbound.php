            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                                    <form class="" action="<?php echo base_url(). 'C_Produsen/input_outbound';?>" method="POST" novalidate>
                                      ...
                                      <br>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <input class="form-control" type="text" name="no_gi" id="no_gi" placeholder="" required="required" value="<?= $kode; ?>" readonly/>
                                            </div>
                                        </div>
