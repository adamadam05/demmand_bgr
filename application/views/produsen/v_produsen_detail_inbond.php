                                      ...
                                      <br>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
																						<input class="form-control" data-validate-length-range="6" data-validate-words="2" name="no_gr" placeholder="<?= $inbound->no_gr; ?>" required="required" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='No_do' name="no_do" data-validate-length-range="5,15" type="text" placeholder="<?= $inbound->no_do; ?>" /></a></div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Tanggal DO</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="do_date" class='date' required="requered" type="date=yyyy/mm/dd" placeholder="<?= $inbound->do_date; ?>" /></div>
                                        </div>
                                       
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">DO Type<span class="required"></span></label>
																				<div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="do_type" class='Do Type' required="required" placeholder="<?= $inbound->do_type; ?>" type="text" /></div>
                                        </div>
                                        ...
                                        <!-- <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Alamat</label>
																				<div class="col-md-6 col-sm-6">
                                                <textarea class="form-control" name="alamat" required="required" placeholder="<?= $inbound->wh_org; ?>" style="width: 500px;"></textarea></div>
                                        </div> -->

                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Warehouse</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="warehouse" class='warehouse' required="required" placeholder="<?= $inbound->wh_dest; ?>" type="text" /></div>
                                        </div>
                                        
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">ETD<span class="required"></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='date' type="date=yyyy/mm/dd" name="date" placeholder="<?= $inbound->etd; ?>" required='required'></div>
                                        </div>

                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">ETA<span class="required"></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='date' type="date=yyyy/mm/dd" name="date" placeholder="<?= $inbound->eta; ?>" required='required'></div>
                                        </div>
