            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <button type="button" class="btn btn-primary" onclick="window.location.replace('produsen_insert_inbond');">Insert Inbond</button>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                          <?php foreach ($inbound as $brt=>$value) :?>
                        <tr>
                         <td><?= $value->no_gr;?></td>
                         <td><?= $value->no_do;?></td>
												 <td><?= $value->do_date;?></td>
												 <td><?= $value->wh_dest;?></td>
                        <td><center>
                            <a href="<?=base_url("c_produsen/inbound_detail/").$value->no_gr; ?>" class="btn btn-secondary btn-sm"><i class="fa fa-folder"></i> View </a>
                            <!-- <a href="#" class="btn btn-info"><i class="fa fa-pencil"></i> Edit </a> -->
                            <a href="<?php echo site_url('c_produsen/delete_inbound/').$value->no_gr; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i> Delete </a>
                            </center></td>
