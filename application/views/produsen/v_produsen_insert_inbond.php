            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                                    <form action="<?php echo base_url(). 'C_Produsen/input_inbound';?>" method="POST">
                                      ...
                                      <br>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <input class="form-control" type="text" name="no_gr" id="no_gr" placeholder="" required="required" value="<?= $kode; ?>" readonly/>
                                          </div>
                                        </div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='no_do' name="no_do" data-validate-length-range="5,15" type="text" placeholder="" /></a></div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Tanggal DO<span class="required"></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='do_date' type="date" name="do_date" placeholder="" required='required'></div>
                                        </div>
                                       
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">DO Type<span class="required"></span></label>
																				<div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="do_type" class='do_type' required="required" placeholder="" type="text" /></div>
                                        </div>

                                        
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Warehouse</label>
                                            <div class="col-md-6 col-sm-6">
											<select name="wh_dest" class="form-control select2" id="wh_dest">
                      <?php

                      foreach ($gudang as $value) {
                echo "<option value='$value->nama_gudang'>$value->nama_gudang</option>";
            }
            ?>
											</select>
											</div>
                      ...
                      <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
											<select name="province_dest" class="form-control select2" id="province_dest">
                      <?php

                      foreach ($provinsi as $value) {
                echo "<option value='$value->nama_provinsi'>$value->nama_provinsi</option>";
            }
            ?>
											</select>
											</div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
											<select name="city_dest" class="form-control select2" id="city_dest">
                      <?php

                      foreach ($kk as $value) {
                echo "<option value='$value->nama_kabupatenkota'>$value->nama_kabupatenkota</option>";
            }
            ?>
											</select>
											</div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='date' type="date" name="etd" placeholder="" ></div>
                                        </div>

                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">ETA<span class="required"></span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='date' type="date" name="eta" placeholder=""></div>
                                        </div>
                        ...
                        <tr>
                         ...
                         <td><?= $value->qty;?></td>
                          <td><center>
                            ...
                            <a href="<?php echo site_url('c_produsen/delete_produk/').$value->kode_penyambung_produk_inbound; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete </a>
                            </center></td>
            ...
            <div class="ln_solid">
                <div class="form-group">
                 <div class="col-md-6 offset-md-3">
                    ...
                    <center> <a href="<?= base_url("c_produsen/produsen_insert_produk"); ?>" class="btn btn-info"> Insert Data Produk </a></center>
                   </div>
                </div>
            </div>
